...
SRC_URI = "git://github.com/brainhasan/Assignment-7-and-later.git;protocol=https;branch=master \
...
PV = "1.0+git${SRCPV}"
SRCREV = "57421081ec0d912e86e290b0d36c9854cdec9287"
...
EXTRA_OEMAKE = "-C ${STAGING_KERNEL_DIR} M=${S}/scull EXTRA_CFLAGS='-I${S}/include -I${S}/scull'"
